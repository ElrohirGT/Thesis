...
% -------------------------------------------------------------------------------
% Nombre completo
\def \nombreestudiante {Flavio André Galán Donis}
% Carné
\def \uvgcarne {22386}
% Facultad
...
% -------------------------------------------------------------------------------
% Título completo
\def \titulotesis {Desarrollo del \textit{inflight software} para la OBC secundaria del Satélite Quetzal-2}
% Año de entrega
\def \anoentrega {2026}
% Asesor
\def \nombreasesor {Ing. Kuk Ho Chung}
